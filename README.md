...
4. installs and loads a launchd LaunchAgent (`com.brain.server`) that runs
   the server at login and keeps it alive, and waits for `/api/health`
...
brain attention                    # needs_attention + blocked, with latest comment
brain show <id>
